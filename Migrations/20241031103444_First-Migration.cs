        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prioritised = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Innmelding", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Innmelding_Users_UserId",
                        column: x => x.UserId,
